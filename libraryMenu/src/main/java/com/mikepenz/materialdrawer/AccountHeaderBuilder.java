...
public class AccountHeaderBuilder {
    ...
    protected TextView mCurrentProfileUser;
    protected TextView mCurrentProfileEmail;
    protected ImageView mProfileFirstView;
    protected ImageView mProfileSecondView;
    protected ImageView mProfileThirdView;
    ...
    public AccountHeader build() {
        ...
        mCurrentProfileView = (de.hdodenhof.circleimageview.CircleImageView) mAccountHeader.findViewById(R.id.material_drawer_account_header_current);
        mCurrentProfileName = (TextView) mAccountHeader.findViewById(R.id.material_drawer_account_header_name);
        mCurrentProfileUser = (TextView) mAccountHeader.findViewById(R.id.material_drawer_account_header_user);
        ...
        mCurrentProfileUser.setTextColor(textColor);
        mCurrentProfileEmail.setTextColor(textColor);

        mProfileFirstView = (CircleImageView) mAccountHeader.findViewById(R.id.material_drawer_account_header_small_first);
        mProfileSecondView = (CircleImageView) mAccountHeader.findViewById(R.id.material_drawer_account_header_small_second);
        mProfileThirdView = (CircleImageView) mAccountHeader.findViewById(R.id.material_drawer_account_header_small_third);
    ...
    protected void buildProfiles() {
        ...
        if (mCurrentProfile != null) {
            ...
            StringHolder.applyTo(mCurrentProfile.getUser(), mCurrentProfileUser);
