        ...
        ViewTreeObserver.OnGlobalLayoutListener
{
    ...
    private Vector<Lesson> vecKeywords;
    private int width;
    private int height;
    ...
    {
        void onRippleViewClicked(View view,Lesson lesson);
    }
     ...
     * @param keyword
     */
    public void addKeyWord(Lesson keyword)
    {
    ...
    public Vector<Lesson> getKeyWords()
    {
        return vecKeywords;
    }
    ...
    {
        random = new Random();
        vecKeywords = new Vector<Lesson>(MAX);
    ...
    public void show()
    {
        ...
        if (width > 0 && height > 0 && vecKeywords != null && vecKeywords.size() > 0)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                final Lesson keyword = vecKeywords.get(i);
                if(keyword!=null) {
                    // 随机颜色
                    ...
                    // 实例化RippleOutView
                    final RippleView txt;
                    if(keyword.getLessonColor()!=null)
                        txt=new RippleView(getContext(),Color.parseColor(keyword.getLessonColor()));
                    else
