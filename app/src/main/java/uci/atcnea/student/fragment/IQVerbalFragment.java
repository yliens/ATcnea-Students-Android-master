 ...
 */
public class IQVerbalFragment extends Fragment implements InteractiveQuestionBase{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.exam_verbal_answer, null);
        ...
        final EditText answer = (EditText) view.findViewById(R.id.et_answer);
    ...
    private void sendVerbalAnswer(String answ) {
    ...
    private final BroadcastReceiver result = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if(intent.hasExtra("IQ_EVALUATION")){
                ...
                if (correct) {
                    text_result.setText(getString(R.string.interactive_question_result_good));
                    img_result.setImageResource(R.drawable.ic_good);
                } else {
                    img_result.setImageResource(R.drawable.ic_wrong);
                    text_result.setText(getString(R.string.interactive_question_result_wrong));
                }
