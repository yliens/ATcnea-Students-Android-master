 ...
 */
public class IQMultipleChoiceFragment extends Fragment implements InteractiveQuestionBase{
    ...
    public IQMultipleChoiceFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getActivity(),
                android.R.layout.simple_list_item_multiple_choice, question.getItems());
