 ...
 */
public class IQTrueFalseFragment extends Fragment implements InteractiveQuestionBase{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.exam_true_or_false_answer, null);
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int k = list.getCheckedItemPosition();
                ATcneaUtil.FLAG_INTERACTIVE_QUESTION_RUN = false;
                Log.e("MY_DEBUG", "change flag to false");
                sendTrueFalseAnswer(k, question);
            }
        });
    ...
    private void sendTrueFalseAnswer(int k, InteractiveQuestion question) {
        ...
        String answ = "null";
        if (k != -1)
            answ = question.getItems().get(k).toLowerCase();
        json += "{\"response\":" + answ + "}";
        json += "]}";
        Log.e("MY_DEBUG", json);
